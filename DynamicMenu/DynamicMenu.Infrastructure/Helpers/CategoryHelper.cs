// -----------------------------------------------------------------------
//  <copyright file="CategoryHelper.cs">
...
namespace DynamicMenu.Infrastructure.Helpers
{
    ...
    /// <summary> Provides helper methods for category logic. </summary>
    public static class CategoryHelper
    {
        /// <summary> Gets the root navigation categories. </summary>
        /// <param name="menus"> The menus entities. </param>
        /// <returns> A <see cref="List{T}" /> of root <see cref="NavigationCategoryViewModel" />s. </returns>
